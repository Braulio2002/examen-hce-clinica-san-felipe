...
import { SaludControlador } from './comun/salud.controlador';
import { AuthControlador } from './modulos/auth/auth.controlador';
import { ComprasControlador } from './modulos/compras/compras.controlador';
import { KardexControlador } from './modulos/kardex/kardex.controlador';
import { ProductosControlador } from './modulos/productos/productos.controlador';
import { VentasControlador } from './modulos/ventas/ventas.controlador';
import { JwtEstrategia } from './seguridad/estrategias/jwt.estrategia';
import { JwtAuthGuardia } from './seguridad/guardias/jwt-auth.guardia';
import { RolesGuardia } from './seguridad/guardias/roles.guardia';
