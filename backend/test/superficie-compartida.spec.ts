...
const CAPA_DE_SIMBOLO: Readonly<Record<string, Capa>> = {
  ...
  CorrelacionInterceptor: 'adaptadores',
  PayloadConCorrelacion: 'adaptadores',
  nuevaCorrelacion: 'adaptadores',
  ejecutarConCorrelacion: 'adaptadores',
  obtenerCorrelacion: 'adaptadores',
  correlacionDesdePayload: 'adaptadores',
  conCorrelacion: 'adaptadores',
